resource "azurerm_dns_cname_record" "dns_int_cname_ca_name" {
  name                = "ca-${var.ca_name}-${var.az_env_name}-${var.az_subscription_name}-${var.az_env_sufix}"
...
resource "azurerm_dns_txt_record" "dns_int_txt_ca_name" {
  name                = "asuid.ca-${var.ca_name}-${var.az_env_name}-${var.az_subscription_name}-${var.az_env_sufix}"
  zone_name           = data.azurerm_dns_zone.dns_int.name
  resource_group_name = data.azurerm_dns_zone.dns_int.resource_group_name
  ttl                 = 300
          ...
          customDomains = [
            {
              ...
              name = "ca-${var.ca_name}-${var.az_env_name}-${var.az_subscription_name}-${var.az_env_sufix}.${data.azurerm_dns_zone.dns_int.name}"
            }
          ]
        },
